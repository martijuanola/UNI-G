...
struct qt_meta_stringdata_Reflection2_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Reflection2_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Reflection2_t qt_meta_stringdata_Reflection2 = {
    {
QT_MOC_LITERAL(0, 0, 11) // "Reflection2"
...
static const uint qt_meta_data_Reflection2[] = {
...
QT_INIT_METAOBJECT const QMetaObject Reflection2::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Reflection2.data,
    qt_meta_data_Reflection2,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Reflection2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Reflection2.stringdata0))
